...
def depositar(saldo, valor, extrato, /):
   if valor > 0:
       ...
       print("\n\033[32mDeposito realizado com sucesso\033[m")
   else:
       print("\n\033[31mDeposito não realizado. Valor incorreto\033[m")
...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
   ...
   if excedeu_saldo:
       print("\033[31mSaque não realizado. Você não tem saldo suficiente!\033[m")


   elif excedeu_limite:
       print("\033[31mSaque não realizado. Número de saques excedido.\033[m")


   elif excedeu_saques:
       print("\033[31mSaque não realizado. Número máximo de saques excedido.\033[m")
